...
app.use(cors({
  origin: 'http://192.168.100.12:8000', // Ganti dengan alamat domain Anda
  methods: 'GET,HEAD,PUT,PATCH,POST,DELETE',
  credentials: true,
}));

app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'http://192.168.100.12:8000');  // Ganti dengan alamat domain Anda
...
mongoose
  .connect("mongodb+srv://evotopia1:evotopia1@cluster0.k43lq2z.mongodb.net/", {
